  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 flex items-center justify-center px-4">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-5 sm:p-6 w-full max-w-md">
        ...
        <h1 className="text-xl sm:text-2xl font-bold text-center mb-5 text-gray-800">
          🎟 CheckMyEntry
        </h1>
        ...
        <div className="space-y-3">
          ...
          <input
            ...
            className="w-full p-3 rounded-lg border border-gray-300 bg-white text-black placeholder-gray-500 focus:ring-2 focus:ring-blue-500 outline-none"
          />
