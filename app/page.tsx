...
const STATIC_REVIEWS = [
  { name: "Priya Sharma", role: "College Fest Coordinator · Jaipur", text: "Absolutely fantastic platform! We had 500+ students at our college fest and not a single queue formed. QR scanning was done in under a second. Highly recommended!", rating: 5, avatar: "P" },
  { name: "Rahul Verma", role: "Tech Meetup Organizer · Delhi", text: "The Excel waitlist upload and automatic ID verification feature is brilliant. What used to take 2 hours of manual checking now completes in 10 minutes flat.", rating: 5, avatar: "R" },
  { name: "Anjali Mehta", role: "Wedding Planner · Mumbai", text: "Used this for a 300-guest wedding reception and not a single duplicate entry got through. The platform looks professional and is incredibly easy to use.", rating: 5, avatar: "A" },
];
         ...
         <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-500 dark:text-neutral-400 font-medium max-w-xl mx-auto">
                See what organizers across India think — and share your own experience from the dashboard.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
